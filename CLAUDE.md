...
- **Comments point to the DD section, they don't re-explain the rule.** e.g. `// see Scheduler Service DD, 3.2, rule 9`, not a restated explanation of why the rule exists. Keeps the single-source-of-truth principle from the design phase intact in the code.
