...
- **Named constants, not magic numbers/strings.** Business hours, the 15-minute slot/buffer, the 30-day window, the lunch-break duration, and every gRPC/HTTP status code should be defined once and referenced, not repeated as literals.
